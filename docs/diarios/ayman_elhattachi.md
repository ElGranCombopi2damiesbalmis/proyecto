...
| 13/10 | S2 | Creacion de la documentación necesaria para el proyecto. | 1h |
...
**Resumen del mes:**
* **Total de horas:** 9h
* **Principales logros:** Coordinacion en el grupo
*  **Área de mejora:** Aprendiendo Git y trabajo en projecto
*  **Próximos objetivos:** Definir el proyecto
...
| 21/03 | S30 | He importado la version 4 del proyecto con las funcionalidades nuevas hechas por Victor y he probado la App viendo que funciona correctamente y que no. | 2h |  |  |  |
| 23/03 | S31 | Añadida funcionalidad del calendario en Tareas. | 2h |  |  |  |
|Pendiente|
